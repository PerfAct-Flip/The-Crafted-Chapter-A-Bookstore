const assets = {
    ...
    quality_icon: new URL("./quality_icon.png", import.meta.url).href,
    support_img: new URL("./support_img.png", import.meta.url).href,

    contact_icon: new URL("./contact_section.jpg", import.meta.url).href,
  }
